...
@Component({
  selector: 'app-exos4-customs-directives',
  templateUrl: './exos4-customs-directives.component.html'
})
export class Exos4CustomsDirectivesComponent implements OnInit {
